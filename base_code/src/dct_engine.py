...
def idct_2d(matrix):
    ...
    # ---- Column transform (direct computation via list literals) -----------
    # Each result element is computed as a single expression to eliminate
    # repeated list-index + accumulate overhead from the old k-loop approach.
    result0 = [
