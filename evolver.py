...
class ChildProcess:
    ...
    def _analyze(self):
        ...
        prompt += (
            ...
            f"IMPORTANT CONTEXT:\n"
            f"- The benchmark tests 3 batch sizes: low (10), medium (200),"
            f" high (10000) blocks — all via idct_2d_batch() API.\n"
            f"- idct_2d_batch receives ALL blocks at once — the engine can"
            f" dispatch to CPU or GPU based on block count.\n"
            ...
            f"- CPU parallelism (rayon, thread pools) also viable.\n"
